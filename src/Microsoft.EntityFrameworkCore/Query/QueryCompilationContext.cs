    ...
    public class QueryCompilationContext
    {
        ...
        private class RequiresMaterializationForGroupJoinQueryModelVisitor : ExpressionTransformingQueryModelVisitor<RequiresMaterializationForGroupJoinExpressionVisitor>
        {
            ...
            public override void VisitGroupJoinClause(GroupJoinClause groupJoinClause, QueryModel queryModel, int index)
            {
                ...
                var containsGroupJoinQueryModelVisitor = new ContainsGroupJoinQueryModelVisitor();
                containsGroupJoinQueryModelVisitor.VisitMainFromClause(queryModel.MainFromClause, queryModel);
                containsGroupJoinQueryModelVisitor.VisitJoinClause(groupJoinClause.JoinClause, queryModel, index);
                if (containsGroupJoinQueryModelVisitor.ContainsGroupJoin)
                {
                    _querySourcesRequiringMaterialization.Add(queryModel.MainFromClause);
                    _querySourcesRequiringMaterialization.Add(groupJoinClause.JoinClause);
                ...
                var mainFromClauseResultQuerySource
                ...
                var addedMainFromClause = false;
                var addedJoinClause = false;
                ...
                {
                    _querySourcesRequiringMaterialization.Add(queryModel.MainFromClause);
                    addedMainFromClause = true;
                }

                var joinClauseResultQuerySource
                    = querySourceTracingExpressionVisitor
                        .FindResultQuerySourceReferenceExpression(
                            queryModel.SelectClause.Selector,
                ...
                if (addedMainFromClause && addedJoinClause)
                {
                    return;
                }
            ...
            private class ContainsGroupJoinQueryModelVisitor : RecursiveQueryModelVisitor
            {
                public bool ContainsGroupJoin { get; private set; }

                public override void VisitGroupJoinClause(GroupJoinClause groupJoinClause, QueryModel queryModel, int index)
                {
                    ContainsGroupJoin = true;
        ...
        private class RecursiveQueryModelVisitor : ExpressionTransformingQueryModelVisitor<RecursiveQueryModelExpressionVisitor>
        {
            public RecursiveQueryModelVisitor()
                : base(new RecursiveQueryModelExpressionVisitor())
            {
                TransformingVisitor.QueryModelVisitor = this;
            }
        }
